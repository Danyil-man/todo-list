...
import { faCheckSquare, faRssSquare, faTrash, faVectorSquare } from "@fortawesome/free-solid-svg-icons";
                        ...
                        {isEdit === item.id ? (
                            ...
                            <div className={style.container}>
                                ...
                                <div className={style.navigationBlock}>
                                    ...
                                    <FontAwesomeIcon onClick={() => editToDo(item.id, item.title)} icon={faTrash} />
