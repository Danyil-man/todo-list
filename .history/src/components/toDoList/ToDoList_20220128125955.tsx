import { faCaretSquareRight, faCheckSquare, faSquare, faSquareFull, faSquareRootAlt, faVectorSquare } from "@fortawesome/free-solid-svg-icons";
                        ...
                        {isEdit === item.id ? (
                            ...
                            <div className={style.container}>
                                <div className={style.checkedBlock}>
                                    {
                                        item.status ? <FontAwesomeIcon onClick={() => statusToDo(item.id)} icon={faSquareRootAlt} />
