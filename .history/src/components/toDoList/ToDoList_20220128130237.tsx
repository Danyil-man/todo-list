import { faBatteryEmpty, faCaretSquareRight, faCheckSquare, faEnvelopeSquare, faSquare, faSquareFull, faSquareRootAlt, faVectorSquare, faWaveSquare } from "@fortawesome/free-solid-svg-icons";
                        ...
                        {isEdit === item.id ? (
                            ...
                            <div className={style.container}>
                                <div className={style.checkedBlock}>
                                    {
                                        item.status ? <FontAwesomeIcon onClick={() => statusToDo(item.id)} icon={faEnvelopeSquare} />
                                            : <FontAwesomeIcon onClick={() => statusToDo(item.id)} icon={['fab', 'check-square']} />
                                    }
