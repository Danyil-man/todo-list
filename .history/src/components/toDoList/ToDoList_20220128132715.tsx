...
import { faCheckSquare, faEdit, faRssSquare, faTrash, faVectorSquare } from "@fortawesome/free-solid-svg-icons";
                        ...
                        {isEdit === item.id ? (
                            ...
                            <div className={style.container}>
                                ...
                                <div className={style.navigationBlock}>
                                    <FontAwesomeIcon onClick={() => deleteToDo(item.id)} icon={faTrash} />
                                    <FontAwesomeIcon onClick={() => editToDo(item.id, item.title)} icon={faEdit} />
